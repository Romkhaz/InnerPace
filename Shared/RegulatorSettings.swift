...
struct RegulatorSettings: Codable, Equatable {
    ...
    /// Ниже этого ритма рекомендации не опускают нижнюю границу. По умолчанию порога
    /// по сути нет, каждый ставит свой: например, 175 тому, кому низкий каденс запрещён.
    var cadenceFloor: Int = 120
